<template>
    <div class="flex flex-row flex-wrap justify-between">
        ...
        <h2 class="funnel-sans-title text-3xl text-white"> View Your Reminders... </h2>  
    ...
    <div class="pt-3 flex flex-row gap-4 justify-between">
        ...
        <h2 class="funnel-sans-title text-3xl text-center text-white"> Current Profile Name: {{ currentProfileName }} </h2>      
