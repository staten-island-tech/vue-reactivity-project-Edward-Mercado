<template>
    <div class="flex flex-row flex-wrap justify-between items-center">
        <button @click="emit('openCreator')" class="btn bg-white hover:bg-emerald-300 active:bg-emerald-500 px-2 text-black funnel-sans-title p-3 text-4xl h-10 w-10 transition duration-150 ease-in-out active:rotate-[-7deg] transform"> + </button>
        <h2 class="funnel-sans-title lg:text-3xl text-2xl text-white"> View Your Reminders... </h2>  
    ...
    <div class="pt-3 flex flex-row gap-4 justify-between items-center">
        ...
        <h2 class="funnel-sans-title lg:text-3xl text-2xl text-center text-white"> Current Profile Name: {{ currentProfileName }} </h2>      
